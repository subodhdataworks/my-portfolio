    ...
    >
      ...
      <div className="text-center mb-10">
        <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-blue-950/70 border border-cyan-500/50 shadow-[0_0_20px_rgba(0,229,255,0.2)] mb-4">
          ...
          <span className="text-xs uppercase tracking-widest font-bold text-cyan-300 font-mono">
        ...
        <p className="text-gray-300 mt-2 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
          Official credential validating Power BI data modeling, DAX measures, and executive dashboard design.
        </p>
      </div>

      {/* Clean, Compact Single Credential Card */}
      <div className="w-full max-w-3xl mx-auto rounded-3xl border border-cyan-500/40 bg-gradient-to-b from-[#0e0730]/90 via-[#07031e]/90 to-[#030014]/90 backdrop-blur-xl p-6 md:p-8 shadow-[0_0_50px_rgba(0,164,239,0.2)] hover:border-cyan-400 transition-all flex flex-col justify-between relative overflow-hidden">
        {/* Subtle Cyber Grid */}
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 border-b border-purple-800/40 pb-6">
            ...
            <div className="relative group cursor-pointer" onClick={() => setIsModalOpen(true)}>
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 flex-shrink-0 drop-shadow-[0_0_25px_rgba(0,164,239,0.55)] group-hover:scale-105 transition-transform duration-300">
                <Image
            ...
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left flex-1">
              ...
              <p className="text-sm text-gray-300 mt-1">
                Issued to <span className="text-cyan-300 font-semibold">Subodh Kumar</span> by{" "}
        ...
        <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-purple-900/40">
          ...
          <Link
            href="https://learn.microsoft.com/users/subodh-kumar/credentials/D7910E2DB3A299BB"
            target="_blank"
            rel="noreferrer noopener"
            className="flex-1 min-w-[160px] py-3 px-4 rounded-xl bg-purple-950/70 hover:bg-purple-900 text-cyan-300 hover:text-white border border-cyan-500/40 hover:border-cyan-400 text-xs sm:text-sm font-semibold flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(0,229,255,0.2)]"
          >
